...
x212134_g_SceneID=2
x212134_g_AccomplishNPC_Name="李工部"
...
x212134_g_MissionName="盖世英雄"
x212134_g_MissionInfo="#{Mis_Hero_end}"
x212134_g_MissionTarget="    在大理城找到李工部#{_INFOAIM160,128,2,李工部}。"
x212134_g_MissionComplete="  呵呵，年轻人，你果然不负众望。行万里路，识万千人，除万种妖，集聪明才智与勇猛果敢于一身，这个盖世英雄的称号赠与你当之无愧！"
x212134_g_MoneyBonus=500000
x212134_g_exp=700000
x212134_g_Custom	= { {id="已找到李工部",num=1} }
