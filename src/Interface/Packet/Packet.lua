...
function Packet_ItemBtnClicked( nLine, nRow )--右键
	...
	local nIsPutItem = 0
	local nExtraLayoutActionButton = {"Pethuantong","PetSoul_ZhuanHua","PetSoul_LevelDown","PetSoul_Fusion","PetSoul_Smash","PetSoul_LevelUp","PetSoul_SoulChange","PetSoul_BloodLevelUp","PetSoul_XiShuxing","Zhen_chonglou","XiaoXiang_ChongXi","xiaoxiang_QiXi_Levelup","Packet_Temporary","TongYongUiDub","TongYongUi","Gemfenli","SuperWeapon9_ShengXing","GemChange","PetIdentifyTwice","PetIdentify","EquipAttributeTransfer","AnqiUp","NewWuhunSkillStudy","WuhunPropertyCreate","AnqiChongxi","AnqiStarUp","VIP_EquipBaoJian_Transfer","VIP_EquipEducation_Transfer","VIP_EquipDWDivert","VIP_EquipNewStrengthen","LongwenLevelUp","LongwenExtraPropertyStudy","LongwenPropertyReset","OnDressPaint","LongwenExtraPropertyStudy2","LongwenExtraPropertyUp","SuperWeaponChange","SuperWeaponJJ","SuperWeaponQH","AnqiCuidu","AnqiJinjie","AnqiLianDu","SuperWeaponTL","SuperWeaponUp","SuperWeaponSoulless","PetHuanhua","WuhunExtraPropertyDel","WuhunExtraPropertyUp","WuhunMagicUp","ShenQiStype","WuhunRH","WuhunSkillStudy","ZhenYuan","WuhunMagicUp_p","Dress_Stiletto","Dress_Enchase","Dress_SplitGem","Dress_Materalcompose","WuhunSkillUp","EquipEducation_Temper","EquipEducation_Decompose","EquipEducation_Transfer","EquipEducation_Update","EquipNewStrengthen","AnqiCuidu","AnqiJinjie","AnqiLianDu","DressPaint","EquipEducation_ShengLing","EquipEducation_JinJie2","GemcomupDate","DecorateWeapon","YbMarketUpItem","PetEquipSuitUp","PetEquipSuitDepart","CardCompose","CardStrengthen","GemChange","SelectCharHeadFrame","SuperWeapon9_DIYSkill2","EquipBaoJian_Transfer","SuperWeaponUp2","SuperWeapon9_ShengJie","WuhunShuXiangChange","Gemcompose","EquipQuickStrengthen","SuperWeapon9_JieMeng","SuperWeaponUpNEW","LongwenStarUp","Packet_Temporary","DecorateWeaponLevelUp","LongwenPropertyResetNEW","EquipBaoshiChange","SuperWeapon9_Change","SuperWeapon9_ShengXing","SuperWeapon9_TuPo","GodWeaponStart_Frame","DressWash","ShenqiSJ","EquipBaoshiyi","Stiletto","DianDang"}
	local nExtraLayoutActionButton_2 = {"ShenQiRepair","Songliao_EquipLevel","Songliao_EquipUp","EquipLingPai_ShengJie","EquipLingPai_OperatingSJ","EquipLingPai_OperatingXQ","EquipLingPai_SkillQH","EquipLingPai_OperatingJS","EquipLingPai_OperatingZC"}
	local nExtraLayoutActionButton_3 = {"Packet_Temporary","SJ_CaiLiaoQiangHua","EquipLingPai_Update","EquipLingPai_Star","EquipDWDivert","DWShengji","DWRonghe","DWHecheng","DWQianghua","DWShike","DWChaichu","Miyu_huanyuan","Miyu_zhizuo","DWChaiJie"}
	...
	if nIsPutItem ~= 1 then
		...
		if(nTheTabIndex == 0) then
			...
			if theAction:GetID() ~= 0 then 
				...
				if nPacketItemID == 30008121 and IsWindowShow("Packet_Temporary") == false then --天机锦囊添加互斥 20190310
					Clear_XSCRIPT();
				...
				if nPacketItemID == 30008122 and IsWindowShow("Packet_Temporary") == false then -- 通天符箓添加
					Clear_XSCRIPT();
						Set_XSCRIPT_Function_Name("Ce_DifuCs");
						Set_XSCRIPT_ScriptID(330060);
						Set_XSCRIPT_Parameter(0,nIndex)
				...
				if nPacketItemID == 30008007 or nPacketItemID == 30505216 then -- 土灵珠添加
