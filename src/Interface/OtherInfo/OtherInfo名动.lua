...
OtherInfo_SetTabColor(4);
	...
	if event == "UI_COMMAND" and tonumber(arg0) == 20210721 then
		OtherInfo_13:AddTextElement(Get_XParam_STR(0))
		return
	end
...
--	OtherInfo_3 : SetText(str)
	...
	-- OtherInfo_13:AddTextElement("VIP信息")
end
...
function OtherInfo_OpenGuanXi_Click()
	Clear_XSCRIPT()
		Set_XSCRIPT_Function_Name( "acme_GetDayItem" );
		Set_XSCRIPT_ScriptID(900035);
		Set_XSCRIPT_ParamCount(0);
	Send_XSCRIPT()
end
--显示武魂UI
