...
{str="曼陀山庄#b(新)",Num=Agname_Kong_goto20},
...
{str="暂定",Num=Agname_Kong_goto14},
{str="暂定",Num=Agname_Kong_goto15},
{str="↑每日必刷↑",Num=Agname_Kong_goto16},
{str="↑每日必刷↑",Num=Agname_Kong_goto17},
{str="↑每日必刷↑",Num=Agname_Kong_goto18},
{str="↑每日必刷↑",Num=Agname_Kong_goto19},
{str="↑每日必刷↑",Num=Agname_Kong_goto20},
}

sceninfo5 = {
-- {str="山洞船坞",Num=Agname_Kong_goto1},
-- {str="温泉洞",Num=Agname_Kong_goto2},
-- {str="剑  冢",Num=Agname_Kong_goto3},
-- {str="野人沟",Num=Agname_Kong_goto4},
-- {str="草料场",Num=Agname_Kong_goto5},
-- {str="天坑树洞",Num=Agname_Kong_goto6},
-- {str="黄龙洞",Num=Agname_Kong_goto7},
-- {str="水晶洞",Num=Agname_Kong_goto8},
-- {str="苗人洞",Num=Agname_Kong_goto9},
-- {str="桃花源",Num=Agname_Kong_goto10},
-- {str="白沙盐湖",Num=Agname_Kong_goto11},
-- {str="先王坟",Num=Agname_Kong_goto12},
-- {str="海贼洞",Num=Agname_Kong_goto13},
-- {str="雪狼湖",Num=Agname_Kong_goto14},
-- {str="火焰谷",Num=Agname_Kong_goto15},
{str="无量山",Num=Agname_Kong_goto1},
{str="敦煌",Num=Agname_Kong_goto2},
{str="嵩山",Num=Agname_Kong_goto3},
{str="等待开放",Num=Agname_Kong_goto4},
{str="←新手BOSS",Num=Agname_Kong_goto5},
{str="雁北",Num=Agname_Kong_goto6},
{str="西湖",Num=Agname_Kong_goto7},
{str="玉溪",Num=Agname_Kong_goto8},
{str="等待开放",Num=Agname_Kong_goto9},
{str="←中级BOSS",Num=Agname_Kong_goto10},
{str="梅岭",Num=Agname_Kong_goto11},
{str="辽西",Num=Agname_Kong_goto12},
{str="琼州",Num=Agname_Kong_goto13},
{str="南海",Num=Agname_Kong_goto14},
{str="←高级BOSS",Num=Agname_Kong_goto15},
